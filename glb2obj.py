...
# blender.exe --background --python D:/Documents/Work/BlenderHelp/glb2ply.py -- D:/Documents/Work/BlenderHelp/objects_categorized/Hospital/Bed/
...
def register():
    ...
    # Walk the folder and look for glb files
    for r, d, f in os.walk(folder_path):
        for file in f:
            if file.endswith('.glb'):
                ...
                # Fix texture paths in mtl and copy textures from Temp folder
